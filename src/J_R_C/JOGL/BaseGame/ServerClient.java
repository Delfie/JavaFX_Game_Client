...
public class ServerClient {
            ...
            public void run() {
                ...
                try {
                    ...
                    Platform.runLater(() -> {
                        ...
                        System.out.println("[Complete the Connection "
                        ...
                        msSecond = new TimerTask() {
                            public void run() {
                                sendPacket(1, Settings._ACCESS_THE_SERVER + "");
                            }
                        };
                    ...
                    // if client exit the game room
                        ...
                        case Settings._ANSWER_GAME_ROOM_MEMEBER_NUMBER:
                            ((GameRoomController)gameRoomController)
                                    .setTheGameRoomMemberNumber(splitPacket);
                            break;
                        ...
                        case Settings._ANSWER_NEW_ROOM_MEMEBER_NOTIFICATION:
                            ((GameRoomController)gameRoomController)
                                    .notificationNewRoomMemeberMessage(splitPacket);
                            break;
                        // answer that the client can not enter the game room
                        case Settings._ANSWER_GUEST_ENTER_THE_ROOM_FAIL:
                            ((WaitingRoomsManagerController)controller).handlePopup("["
                                    + splitPacket[1] + "] 인원이 가득찼습니다.");
                            break;
                        ...
                        case Settings._ANSWER_REGISTER_NEW_USER:
                            ((LoginController)loginController)
                                    .checkTheNewUserRegisterSuccess(splitPacket);
                            break;
                        ...
                        case Settings._ANSWER_CATCHME_INIT_PLAY_CLICKED_NUMBER:
                            ((GameRoomController)gameRoomController)
                                    .catchmeClickPlayNumberSet(splitPacket);
                            break;
     ...
     * @return
     */
    String[] splitMultiplePacket(String packet) {
        int flag;
        int packetNumber = 0;
        String subPacket;
